...
Feature: REP-ICONS-SWEEP - Reemplazar iconos Material Symbols por Lucide en toda la app (fuente externa fallaba)
  ...
  # ----------------------------------------------------------------------------
  Background:
    Given the environment is initialized for "REP-ICONS-SWEEP"
