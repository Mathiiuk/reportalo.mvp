...
export const INITIAL_LEGAL_CORPUS = [
  ...
  // Aplica en PBA/Avellaneda vía adhesión provincial Ley 13.927. No aplica en CABA para estacionamiento/tránsito municipal.
  {
    ...
    fuente_url: 'http://servicios.infoleg.gob.ar/infolegInternet/anexos/0-4999/818/norma.htm',
    vigencia: 'vigente',
    version: '1.0',
  },
  ...
  // Fragmento 7: Ley 451 CABA (Tránsito / Sanción)
  {
    ...
    fuente_url: 'https://juristeca.jusbaires.gob.ar/compilacion-normativa-juristeca/ley-451',
    vigencia: 'vigente',
    version: '1.0',
  },
